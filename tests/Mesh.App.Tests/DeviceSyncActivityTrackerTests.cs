...
[TestClass]
public sealed class DeviceSyncActivityTrackerTests
{
    [TestMethod]
    public async Task SnapshotActivity_StaysVisibleUntilTheQuietPeriodCompletes()
    {
        var delay = new ManualDelay();
        var tracker = new DeviceSyncActivityTracker(TimeSpan.FromSeconds(1), delay.WaitAsync);
        ...
        tracker.ObserveSnapshotActivity();
