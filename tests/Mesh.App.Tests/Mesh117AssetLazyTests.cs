...
/// <summary>
/// Behavioral tests for the Mesh 1.17 lazy-asset core: the bounded LRU content cache, the
...
[TestClass]
[DoNotParallelize]
public sealed class Mesh117AssetLazyTests
{
    ...
    public void Hydration_PagesSummariesOnly_MaterialisesZeroBodies()
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            db.UpsertAsset(record, content, createOutboxEntry: false);
        }
    ...
    public void MetadataEdit_PreservesUnloadedBody()
    {
        ...
        db.UpsertAsset(metadataOnly, existing.Content, createOutboxEntry: false);
    ...
    public void Delete_TombstonesOneRow_AndDropsContent()
    {
        ...
        db.DeleteAsset(AssetKind.Skill, "s", DeviceId, createOutboxEntry: false);
