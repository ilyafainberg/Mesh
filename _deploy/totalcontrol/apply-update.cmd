...
:: ============================================================================
::  apply-update.cmd — update applier for TotalControl.
::
...
echo Waiting for TotalControl (PID %APP_PID%) to close...
set /a _tries=0
:waitloop
...
:: Refresh MCP registration from the new build.
...
echo latest release from https://github.com/ilyafainberg/TotalControl-MCP-Server/releases
if defined STAGE rmdir /S /Q "%STAGE%" >nul 2>&1
endlocal
exit /b 1
