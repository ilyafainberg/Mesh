...
/// </summary>
internal sealed class DeviceSyncActivityTracker
{
    ...
    public DeviceSyncActivityTracker(TimeSpan quietPeriod)
        : this(quietPeriod, Task.Delay)
    {
    }

    internal DeviceSyncActivityTracker(
    ...
    public void ObserveSnapshotActivity()
    {
