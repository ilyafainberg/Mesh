...
public sealed partial class AppState
{
    ...
    private static OwnThread CloneBootstrapThread(OwnThread thread)
        => new()
        {
            ...
            AgentExecutionHostDeviceId = thread.AgentExecutionHostDeviceId,
            AgentExecutionHostDeviceName = thread.AgentExecutionHostDeviceName,
            AgentExecutionHostDevicePlatform = thread.AgentExecutionHostDevicePlatform,
